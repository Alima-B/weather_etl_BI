...
from BI.helpers_BI import get_aqi_color,get_aqi_label,get_temp_color,trend_icon,advisory_html,weather_condition_details,uvi_color
from BI.data_loader import load_hourly_period,load_agg_data
from data_gen import fill_df_jour
...
# def render_map_page(df_agg,data_heure) : 
    ...
    with tab_hourly:
        ...
        if data_heure.empty:
            ...
            # fill avec fake data
            df_plot = fill_df_jour(df=df_plot,datetime_col="datetime")
            ...
            df_full = pd.concat([df_plot, meteo_forecast], axis = 0,ignore_index = True)
