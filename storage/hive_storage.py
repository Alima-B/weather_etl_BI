...
v4 : 
    save_weather_hourly_records : all elements in hourly list are saved
"""
...
class HivePartitionedStorage:
    ...
    def save_weather_hourly_records(
        ...
        V4 : 
            all elements in hourly list are saved
        ...
        # old version that only keeps one hour without the forecast
