...
def _concentration_to_aqi(c: float, pollutant: str) -> int | None:
    ...
    Returns None if out of breakpoints.
    """
...
def add_forecast_to_daily_json(
    ...
    for entry in future_entries:
        ...
        hour = datetime.fromisoformat(timestamp_utc).hour if timestamp_utc else None
        ...
        last_forecast.append({
            "dt": dt,
            "hour_utc": hour,
            "hour_utc_formatted": f"{hour:02d}:00" if hour is not None else None,
